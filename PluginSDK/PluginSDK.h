...
namespace UltraEngine::PluginSDK
{
	...
	public:
		...
		bool Save(PluginSDK::MemWriter* writer, const int flags);
	};
	...
	public:
		...
		bool Load(PluginSDK::MemReader* reader, const std::wstring cachewritepath = L"", const std::wstring cachereadpath = L"", const int flags = 0);
	};
}