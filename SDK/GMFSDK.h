...
namespace GMFSDK
{
	...
	public:
		...
		uint64_t AddVertex(const float x, const float y, const float z, const float nx = 0.0f, const float ny = 0.0f, const float nz = 0.0f, const float u0 = 0.0f, const float v0 = 0.0f, const float u1 = 0.0f, const float v1=0.0f, const unsigned char r = 255, const unsigned char g = 255, const unsigned char b = 255, const unsigned char a=255, const float displacement = 1.0f);
